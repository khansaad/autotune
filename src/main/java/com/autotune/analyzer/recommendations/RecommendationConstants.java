...
public class RecommendationConstants {
    ...
    public static final class RecommendationNotificationMsgConstant {
        ...
        public static final String CPU_REQUESTS_UNDER_PROVISIONED = "Workload is under-provisioned for CPU. Kruize recommends increasing CPU allocation.";
        public static final String CPU_REQUESTS_OVER_PROVISIONED = "Workload is over-provisioned for CPU. Kruize recommends reducing CPU allocation to optimize costs.";
        public static final String CPU_LIMITS_UNDER_PROVISIONED = "Workload is under-provisioned for CPU LIMITS. Kruize recommends increasing CPU limit allocation.";
        public static final String CPU_LIMITS_OVER_PROVISIONED = "Workload is over-provisioned for CPU LIMITS. Kruize recommends reducing CPU limit allocation to optimize costs.";
        ...
        public static final String MEMORY_REQUESTS_UNDER_PROVISIONED = "Workload is under-provisioned for Memory. Kruize recommends increasing Memory allocation.";
        public static final String MEMORY_REQUESTS_OVER_PROVISIONED = "Workload is over-provisioned for Memory. Kruize recommends reducing Memory allocation to optimize costs.";
        public static final String MEMORY_LIMITS_UNDER_PROVISIONED = "Workload is under-provisioned for Memory LIMITS. Kruize recommends increasing Memory limit allocation.";
        public static final String MEMORY_LIMITS_OVER_PROVISIONED = "Workload is over-provisioned for Memory LIMITS. Kruize recommends reducing Memory limit allocation to optimize costs.";
