...
| 323009 | NOTICE |      CPU_LIMITS_OVER_PROVISIONED      |         Specifies that the workload is over-provisioned for CPU limits          | Workload is over-provisioned for CPU LIMITS. Kruize recommends reducing CPU limit allocation to optimize costs. | DATA USER |
...
| 324008 |  NOTICE  |    MEMORY_LIMITS_OVER_PROVISIONED     |        Specifies that the workload is over-provisioned for Memory limits        | Workload is over-provisioned for Memory LIMITS. Kruize recommends reducing Memory limit allocation to optimize costs. | DATA USER |
